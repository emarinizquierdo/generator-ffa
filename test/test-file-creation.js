...
describe('Angular generator', function () {
  ...
  beforeEach(function (done) {
    ...
    helpers.testDirectory(path.join(__dirname, 'temp'), function (err) {
      ...
      angular = helpers.createGenerator('ffa:app', deps);
  ...
  describe('Controller', function () {
    it('should generate a new controller', function (done) {
      var angularCtrl;
      var deps = ['../../controller'];
      angularCtrl = helpers.createGenerator('ffa:controller', deps, ['foo']);
  ...
  describe('View', function () {
    it('should generate a new view', function (done) {
      var angularView;
      var deps = ['../../view'];
      angularView = helpers.createGenerator('ffa:view', deps, ['foo']);
