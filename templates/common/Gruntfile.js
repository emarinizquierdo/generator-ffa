...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    rename : {
      dist: {
        files: [
            {src: ['<%%= yeoman.app %>/index.jsp'], dest: '<%%= yeoman.app %>/index.html'}
          ]
      },
      revert: {
        files: [
            {src: ['<%%= yeoman.app %>/index.html'], dest: '<%%= yeoman.app %>/index.jsp'},
    ...
    manifest: {
      dev: {
        ...
        src: [
            yeomanConfig.name + '/**/*.{js,html,ico,png,jpg}'
          , 'vendor/**/*.{js,html,ico,png,jpg}'
        ],
